...
const productId = "9c319627-6989-45cc-8aea-de32eb93941e";
...
const id = await resolveViaCosing("Hamamelis Virginiana Leaf Extract");
await addAliasAndLink("버지니아풍년화잎추출물", id, 20);
console.log(JSON.stringify({ "버지니아풍년화잎추출물": id }, null, 2));
await sql.end();
