...
const koreanToEnglish = [
  ...
  ["하이드롤라이즈드하이알루로닉애씨드", "Hydrolyzed Hyaluronic Acid"], // "(1,000ppm)"
  ...
  ["버지니아풍년화잎추출물", "Hamamelis Virginiana (Witch Hazel) Leaf Extract"],
  ...
  ["모란뿌리추출물", "Paeonia Suffruticosa Root Extract"],
];
...
// [NEW] 토리든 다이브인 저분자 히알루론산 세럼 50ml, 올리브영(oliveyoung.co.kr) 국내 판매, country='KR'.
...
const [product] = await sql`
  ...
  VALUES (
    ...
    '올리브영',
    'KR',
    'https://www.oliveyoung.co.kr/store/goods/getGoodsDetail.do?goodsNo=A000000258298',
    'https://image.oliveyoung.co.kr/cfimages/cf-goods/uploads/images/thumbnails/10/0000/0025/A00000025829806ko.jpg?l=ko',
    'none', 'light', true
  )
  RETURNING id
`;
